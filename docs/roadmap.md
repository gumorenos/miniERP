...
- **Captura multi-turno — publicada, pendiente de QA.** El candidato `72f6d5a932f65310357d6517da88cab95a52f70a` y la migración 0016 asocian mensajes por conversación, permiten completar el mismo borrador, registran cada mensaje y evitan replay/duplicados. No desplegar hasta pasar QA aislado.
