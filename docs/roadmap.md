...
Última actualización: 2026-09-05. Documentación canónica: `continuidad.md`, `qa.md`, `openclaw-qa.md` y este archivo.
...
- **Captura conversacional — núcleo v1, hardening inicial y webhook directo de Telegram implementados y desplegados.** Producción está en `291aeb1eab75a2222c0bf577d45b3dbcd4f60953`, con QA aislado, E2E, concurrencia/idempotencia, migraciones 0016, Docker, health y smoke autenticado PASS. El webhook está activo. OpenClaw queda fuera del runtime.
...
- **Parser Telegram — validado y desplegado.** `291aeb1eab75a2222c0bf577d45b3dbcd4f60953` reconoce respuestas aisladas de talla y evita mezclar `cliente: Ana` con la descripción del pedido. Queda pendiente aprender casos adicionales del uso real.
- **WhatsApp Cloud API — candidato publicado, QA/deploy pendientes.** `f2a12ba197345f5f019b56d0bde98909eecebb28` reutiliza el núcleo conversacional y añade webhook firmado, allowlist, botones/listas, idempotencia y confirmación humana.
